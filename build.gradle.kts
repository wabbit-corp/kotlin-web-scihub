...
dependencies {
    implementation(project(":kotlin-pprint")) // 1.0.0
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-web-scihub/tree/master/src/main/kotlin")
